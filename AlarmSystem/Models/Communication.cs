    ...
    class SqlDatabase
    {
        ...
        public void OpenConnection()
        {
            ...
            catch (Exception e)
            {
                if (attempts >= 3)
                {
                    errorMessage = "An error occured when attempting to reach the SQL server, Please check your connection and try again.\r\n" + e.Message;
        ...
        public void RunProcedure(string storedProcedure, object[,] values)
        {
            ...
            catch (Exception e)
            {
                ...
                errorMessage = "could not run the stored procedure: " + storedProcedure + ", because of the error:\r\n" + e.Message;
