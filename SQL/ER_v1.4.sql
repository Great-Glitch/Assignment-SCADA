...
CREATE VIEW [vActivatedAlarms]([AlarmName],[AlarmType],[AlarmDescription],[TagName],[AlarmLimit],[ActivationTime],[TagId],[AlarmId],[AcknowledgeTime],[FirstName],[PriorityName],[TagUnit],[TagDescription])
AS
SELECT [ALARMLIST].[AlarmName],[ALARMLIST].[AlarmType],[ALARMLIST].[AlarmDescription],[TAG].[TagName],[ALARMCONFIGURATION].[AlarmLimit],[ALARM].[ActivationTime],[ALARM].[TagId],[ALARM].[AlarmId],[ALARM].[AcknowledgeTime],[OPERATOR].[FirstName],[PRIORITYLIST].[PriorityName],[TAG].[TagUnit],[TAG].[TagDescription]
	FROM [ALARMLIST],[TAG],[ALARMCONFIGURATION],[ALARM],[OPERATOR],[PRIORITYLIST]
